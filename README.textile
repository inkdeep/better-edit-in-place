...
| _size |  '30x5' (only used with text_field and text_area input types) |
...
| afterSave | false (can be passed a function to act on updated element such as changing the class)|

h3. TODO

* Clean up _size setting handling
